  ...
  return (
    <>
      <SEO
        ...
        description="Proyectos desarrollados con React, Node.js y MongoDB. Aplicaciones web modernas enfocadas en rendimiento, arquitectura y experiencia de usuario."
