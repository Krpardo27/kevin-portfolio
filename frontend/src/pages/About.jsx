...
const About = () => {
  return (
    <>
      <SEO
        title="Sobre mí | Kevin Pardo – Desarrollador React"
        description="Desarrollador frontend especializado en React, Tailwind y aplicaciones modernas."
      ...
      <section className="lg:mt-32 mt-8 px-4 py-5 flex flex-col items-center justify-center">
        <header className="text-center mb-20 w-full">
          ...
          <p className="lg:text-lg text-[15px] text-gray-400 max-w-3xl mx-auto leading-relaxed">
            ...
            mantenibilidad. Mi foco está en código limpio y experiencias
            digitales bien pensadas.
          </p>
        </header>
